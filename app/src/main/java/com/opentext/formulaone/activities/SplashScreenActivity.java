...
import com.opentext.formulaone.services.DriverDetailsService;
...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Creating intent for DriverDetailsService
        intent = new Intent(this, DriverDetailsService.class);

        if(hasPermissions()) {
            Log.d(LOG_TAG, "Starting DriverDetailsService...");
            startService(intent);
